...
// biome-ignore lint/suspicious/noShadowRestrictedNames: <Supress Global Variable name>
const Map = forwardRef<MapRef, MapProps>(function Map(
	...
	// Initialize the map
	// biome-ignore lint/correctness/useExhaustiveDependencies: <Supress dependencies>
	useEffect(() => {
